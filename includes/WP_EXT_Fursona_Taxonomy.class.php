...
/**
 * Class WP_EXT_Fursona_Taxonomy
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Fursona_Taxonomy extends WP_EXT_Fursona {
	...
	public function taxonomy_meta() {
		$labels  = [
			'name'                       => _x( 'Fursona Meta', 'Meta General Name', 'wp-ext-' . $this->domain_ID ),
 ...
 *
 * @return WP_EXT_Fursona_Taxonomy
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Fursona_Taxonomy() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Fursona_Taxonomy;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Fursona_Taxonomy(), 'run' ] );
