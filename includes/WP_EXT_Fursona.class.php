...
class WP_EXT_Fursona {
	...
	public function __construct() {
		// Settings.
		$this->pt_ID      = 'fursona';
		$this->archive_ID = 'fursonas';
		$this->domain_ID  = 'fursona';
		$this->cap_type   = [ 'pt_fursona', 'pt_fursonas' ];
 ...
 *
 * @return WP_EXT_Fursona
 */
function WP_EXT_Fursona() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Fursona;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Fursona(), 'run' ] );
