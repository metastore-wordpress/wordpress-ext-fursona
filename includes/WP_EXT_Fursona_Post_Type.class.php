...
/**
 * Class WP_EXT_Fursona_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Fursona_Post_Type extends WP_EXT_Fursona {
	...
	public function post_type() {
		$labels       = [
			'name'                  => _x( 'Fursonas', 'Fursona General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Fursona', 'Fursona Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Fursonas', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Fursona', 'wp-ext-' . $this->domain_ID ),
		...
		$args         = [
			'label'               => __( 'Fursona', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Fursona Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_Fursona_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Fursona_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Fursona_Post_Type;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Fursona_Post_Type(), 'run' ] );
