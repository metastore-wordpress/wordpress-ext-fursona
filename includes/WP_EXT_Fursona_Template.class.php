...
/**
 * Class WP_EXT_Fursona_Template
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Fursona_Template extends WP_EXT_Fursona {
 ...
 *
 * @return WP_EXT_Fursona_Template
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Fursona_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Fursona_Template;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Fursona_Template(), 'run' ] );
